...
<body>
 ...
 <div id="mostrar_mensaje"></div>
    ...
    <div class="card">     
        <div class="imagen">                
            <img src="./images/formulario.jpg" alt="Ejemplo" style="width: 100%; height:180px">               
        </div>   
        <div class="card-body">            
            ...
            !! Importante: para Modificarantes debes de consultar el si el producto se encuentra. ¡¡
            </div>
            <form style="margin-top: 100px;">
            <!-- Codigo -->
           <div class="row">
           <div class="col form-outline mb-4">
             <input type="text" id="codigo" name="codigo" placeholder="" class="form-control text-center" value="<?php echo $_SESSION['codigo']?>"/>
           </div>
           <!-- Nombre -->
          <div class="col form-outline mb-4">
           <input type="text" id="nombre" name="nombre" class="form-control text-center" placeholder="" value="<?php echo $_SESSION['nombre']?>"/>
          </div>
          </div>
          <!-- Marca -->
          <div class="row">
            <div class="col form-outline mb-4">
              <input type="text" id="marca" name="marca" placeholder="" class="form-control text-center" value="<?php echo $_SESSION['marca']?>"/>
            </div>
            <!-- Precio -->
           <div class="col form-outline mb-4">
            <input type="text" id="precio" name="precio" class="form-control text-center" placeholder="<?php echo $_SESSION['precio']?>" value="<?php echo $_SESSION['precio']?>"/>
           </div>
           <!-- Cantidad -->
           <div class="col form-outline mb-4">
            <input type="text" id="cantidad" name="cantidad" class="form-control text-center" placeholder="" value="<?php echo $_SESSION['cantidad']?>"/>
           </div>
         </div>
         <div class="text-center">          
          <button  class="btn btn-success btn-lg" onclick="consultar()">Consultar Producto</button>
          <button  class="btn btn-dark btn-lg" onclick="actualizar()">Modificar Producto</button>
         </div>
         </form>
        </div>
    </div>
